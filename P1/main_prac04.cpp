...
/* ----------------   Pr�ctica 4 --------------------------*/
/*-----------------    2024-1   ---------------------------*/
/*------------- Alumno Mario Alberto Sanchez Maldonado                     ---------------*/
/*------------- No. de cuenta:  314162588            ---------------*/
#include <glew.h>
#include <glfw3.h>
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		glDrawArrays(GL_TRIANGLES, 0, 36); // 1
		...
		Temp02 = modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -3.0f, 0.0f));
		...
		myShader.setMat4("model", modelOp);
		myShader.setVec3("aColor", glm::vec3(0.0f, 1.3f, 1.3f));
		glDrawArrays(GL_TRIANGLES, 0, 36); //Piernas
		...
		//factor de escala = valor final/valor inicial
